...
OUTPUT = Path(os.getenv("V045_CLASSIFICATION_OUTPUT", ROOT / "results" / "termination_v045" / "classification_v045.json"))
...
def main() -> None:
    ...
    payload = {
        ...
        "rules_changed_for_v0.4.5": False,
        "rows": len(classified),
